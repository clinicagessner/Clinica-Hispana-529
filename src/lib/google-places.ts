...
// Places API (New) — la key de esta clínica solo tiene habilitada la API nueva
// (places.googleapis.com); la legacy maps/api/place/details devuelve REQUEST_DENIED.
