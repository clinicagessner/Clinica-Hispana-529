...
const copy = {
  es: {
    ...
    metaDescription:
      "Atención médica profesional 100% en español. Sin cita previa, walk-ins. Más de 500 reseñas 5★ en Google. Llame: (281) 694-7250",
    ...
    faqItems: [
      ...
      },
      {
        ...
        a: "Estamos en 15003 FM 529 B, Houston TX 77095, en el norte de Houston cerca de la autopista 59/69. Estacionamiento gratuito y fácil acceso en transporte público.",
      },
    ],
  ...
  en: {
    ...
    metaDescription:
      "Professional medical care 100% in Spanish. Walk-ins welcome, no appointment needed. 500+ 5-star Google reviews. Call: (281) 694-7250",
    ...
    faqItems: [
      ...
      },
      {
        ...
        a: "We're at 15003 FM 529 B, Houston TX 77095, in north Houston near Highway 59/69. Free parking and easy public transportation access.",
      },
    ],
    ...
    <main>
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        <Image
          ...
          alt="Clínica Hispana Familiar 529 - Houston TX"
          width={1920}
          height={1080}
          priority
          fetchPriority="high"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 max-w-5xl mx-auto">
            {featuredServices.map((service) => (
              ...
              >
                <Image
                  src={service.image}
                  alt={`${service.title} - Clínica Hispana Familiar 529 Houston`}
                  fill
