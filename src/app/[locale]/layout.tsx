...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    // TODO(randy): añadir verification.google cuando se cree la propiedad de
    // Search Console de clinica529.com (no reutilizar tokens de otra clínica).
  };
}
    ...
    <html lang={locale} data-scroll-behavior="smooth" className={`${montserrat.variable} ${sourceSans.variable}`} suppressHydrationWarning>
      <head>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=888903807489226&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
      </head>
      ...
      <Script id="meta-pixel" strategy="afterInteractive">
        {`
          ...
          fbq('init', '888903807489226');
          fbq('track', 'PageView');
        `}
      </Script>
      <Script
        src="https://www.googletagmanager.com/gtag/js?id=AW-16446708149"
