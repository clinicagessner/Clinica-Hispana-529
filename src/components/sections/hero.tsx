...
export async function Hero() {
  ...
  const whatsappHref = `https://wa.me/${CONTACT_INFO.phone.replace(/\D/g, "")}?text=${encodeURIComponent(tCta("whatsappMessage"))}`;
          ...
          <div className="animate-hero-cta flex flex-col sm:flex-row gap-3 justify-center mb-4">
            ...
            >
              <a
                ...
                aria-label={`${tCta("whatsapp")} ${CONTACT_INFO.phoneFormatted}`}
              >
